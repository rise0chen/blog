...
```
将/root/ovpn-data中的CLIENTNAME.ovpn文件 下载到本地，利用OpenVPN GUI连接即可。  
...
## 相关链接
[五分钟利用docker搭建好openvpn服务环境](https://blog.csdn.net/technofiend/article/details/52452572)  
